 ...
 * (Кузнецова-Иванова, Анна-Мария), а на конце слова — точка.
 *
 ...
 *
 * Точку на конце слова допускаем отдельно: телефонная клавиатура сама её
 * подставляет двойным тапом по пробелу или в конце фразы, человек этого не
 * замечает — и не мог зарегистрироваться с настоящей фамилией. Только на конце
 * слова, не посреди: «И.И.» вместо имени по-прежнему не похоже на ФИО.
 */
